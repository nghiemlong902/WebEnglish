...
<html>
  <head>
    ...
    <script type="text/javascript" src='<c:url value="/resources/vendors/jquery/dist/jquery.min.js"></c:url>'></script>
      <link href='<c:url  value="/resources/vendors/jquery/dist/jquery.min.js"></c:url>' rel="stylesheet">
    ...
    <link href='<c:url value="/resources/vendors/fullcalendar/dist/fullcalendar.min.css"></c:url>' rel="stylesheet">
    <link href='<c:url value="/resources/vendors/fullcalendar/dist/fullcalendar.print.css"></c:url>' rel="stylesheet">
  ...
  <body class="nav-md">
    ...
    <script src='<c:url value="/resources/vendors/fullcalendar/dist/fullcalendar.js"></c:url>'></script>
