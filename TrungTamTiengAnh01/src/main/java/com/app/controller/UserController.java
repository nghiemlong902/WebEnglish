...
public class UserController {
	...
	public String listUser(Model model,@ModelAttribute("searchForm") Users userDTO,@PathVariable("page") int page
			,HttpSession session) {
		Paging paging = new Paging(5);
		paging.setIndexPage(page);
		List<Users> list = userService.getAll(userDTO, paging);
	...
	public String viewUser(Model model,@PathVariable("id") int id) {
		Users userDTO = userService.findById(id);
	...
	public String saveUser(Model model,@ModelAttribute("submitForm") @Validated Users userDTO
